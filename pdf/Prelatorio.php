  ...
  <br/>
    ...
    <tbody>";
        ...
        foreach ($listaProd as $prod) {
            ...
            $html .= "<td>" . $prod['prod_nome'] . "</td>";
            $html .= "<td>" . $prod['prod_quant'] . "</td>";
            $html .= "<td>" . $prod['prod_preço'] . "</td>";
            $html .= "<td>" . $prod['prod_desc'] . "</td>";
            $html .= "<td>" . $prod['prod_img1'] . "</td>";
            $html .= "<td>" . $prod['prod_img2'] . "</td>";
            $html .= "<td>" . $prod['prod_img3'] . "</td>";
            $html .= "</tr>";
        }
...
$dompdf->render();
$dompdf->stream("Produtos", array("Attachment" => false));
