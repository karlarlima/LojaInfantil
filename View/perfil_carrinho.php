          ...
          <div class="container-perfil-right">
            <div class="header-carrinho">
                <div class="meuPerfil-description">
                    ...
                    <div class="description">
                        <h2>Carrinho</h2>
                        <p>Gerenciar e atualizar seus produtos do carrinho</p>
                    </div>
                </div>
                <div class="nav-carrinho">
                    <a href="perfil_carrinho.php" class="item active">Meu Carrinho
                    </a>
                    <a class="item" href="carrinho_compra.php">Continuar Compra
                    </a>
                    <a class="item" href="carrinho_finalizar.php">Finalizar
                    </a>
                </div>
            </div>
            <!--
            <ul class="container-products-carrinho">
              <div class="meuPerfil-options-carrinho">
                <div class="carrinho-container">
                  <img src="../IMG/sacolas-de-compras.png" alt="">
            ...
            <div class="container-carrinho">
                <table>
                    <thead>
                        <tr>
                            <th class="table-title">Itens</th>
                            <th class="table-title">Quantidade</th>
                            <th class="table-title">Valor PIX</th>
                            <th class="table-title">Valor Cartão</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="product-row">
                            <td class="table-row">
                                <div class="product-item">
                                    <img src="../IMG/acessorios/Acessorios (1000 × 1000 px)/1.png" alt="">
                                    <a href="#">Conjunto Infantil Roupa 1</a>
                                </div>                        
                            </td>
                            <td class='table-row'>1</td>
                            <td class='table-row'>R$ 50,00</td>
                            <td class='table-row'>R$ 67,00</td>
                            <td class='table-row'><a onclick="open_popup_excluir();" href="#" class="btn-delete"><i class="ri-delete-bin-fill"></i></a></td>                      
                        </tr>  
                        <tr class="product-row">
                            <td class="table-row">
                                <div class="product-item">
                                    <img src="../IMG/acessorios/Acessorios (1000 × 1000 px)/17.png" alt="">
                                    <a href="#">Conjunto Infantil Roupa 2</a>
                                </div>                        
                            </td>
                            <td class='table-row'>1</td>
                            <td class='table-row'>R$ 50,00</td>
                ...
                <div class="resumo">
                    ...
                    <div class="price-container">
                        <span class="title-price">Valor</span>
                        <div class="price">
                            <h4>R$ 100,00</h4>
                            <span>no PIX</span>
                        </div>
                    </div>
                    <a href="carrinho_compra.php">Compre agora(2)</a>
                </div>
            </div>
