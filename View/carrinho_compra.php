          ...
          <div class="container-perfil-right">
            <div class="header-carrinho">
                ...
                <div class="nav-carrinho">
                    ...
                    <a class="item active" href="carrinho_compra.php">Continuar Compra
                    </a>
                ...
                <div class="detalhes-container">
                    <div class="container-endereco">
                        ...
                        <div class="endereco">
                            ...
                            <a href="#">Alterar o endereço</a>
                        </div>
                    </div>
                    <div class="carrinho-pagamento">
                        <h3>Método de pagamento</h3>
                        <div class="btns-pagamento">
                            <button class="active">PIX</button>
                            <button>Cartão de Crédito/Débito</button>
                        </div>
                    </div>
                </div>                
                <div class="resumo">
                    ...
                    <a href="carrinho_finalizar.php">Finalizar pedido(2)</a>
                </div>
            </div>
          </div>
        </div> 
        ...
        <div class="container-carrinho">
                <div class="detalhes-container">
                    ...
                    <div class="carrinho-pagamento">
                        ...
                        <div class="btns-pagamento">
                            <button>PIX</button>
                            <button class="active">Cartão de Crédito/Débito</button>
                        </div>
                    </div>
                </div>   
                <div class="detalhes-right">
                    ...
                    <form class="cartao-container">
                        <h3></h3>
                        <div class="cartao">
                            <input type="text" placeholder="No. do cartão">
