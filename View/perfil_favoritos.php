        ...
        <div class="perfil">
          <div class="container-perfil-left">
            <div class="perfil-options">
              ...
              <a href="perfil_favoritos.php"  class="active"><i class="ri-heart-3-fill"></i></a>
            </div>
            <a href="sair_perfil.php"><i class="ri-logout-circle-line"></i></a>
          </div>
          <div class="container-perfil-right">
            <div class="meuPerfil-description">
                ...
                <div class="description">
                    <h2>Favoritos</h2>
                    <p>Gerenciar e atualizar seus produtos favoritos</p>
                </div>
            </div>
            
            <ul class='container-products-favoritos'>
            <div class='meuPerfil-options-favoritos'>
            <?php
           ...
           $sql = "SELECT favoritos.fav_id, favoritos.fav_cli, produto.prod_id, produto.prod_nome, produto.prod_preco, produto.prod_img1, categoria.cat_categoria, subcategoria.sub_cat FROM favoritos INNER JOIN produto ON favoritos.fav_prod = produto.prod_id INNER JOIN categoria ON produto.prod_cat = categoria.cat_id INNER JOIN subcategoria ON produto.prod_sub = subcategoria.sub_id where fav_cli =".$_SESSION['cli_id'];
            ...
            $resultado = $instanciaPDO->query($sql);
                ...
                if ($resultado->rowCount() > 0) {
                  while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class='card'>
                        <li>                            
                          <a href='#'><img src='../IMG/".$row['cat_categoria']."/".$row['prod_img1']."'></a>
                          <div class='card-content'>
                              ...
                              <div class='container-btns'>
                                  ...
                                  <a href='perfil_favoritos.php?del_Fav=".$row['fav_id']."'class='btn-delete'><i class='ri-delete-bin-fill'></i></a>
                        ...
                        if (isset($_GET['del_Fav'])) {
                          if (!isset($_SESSION['cli_id'])) {
                              ...
                              $sql = "DELETE FROM favoritos WHERE fav_cli = :cli_id AND fav_id = :fav_id";
            ...
            echo"
            <div class='meuPerfil-options-carrinho'>
              <div class='carrinho-container'>
                <img src='../IMG/adicionar-aos-favoritos.png' alt=''>
                <div class='descricao-carrinho'>
                  <h3>Favoritos Vazio</h3>
                  <p>Adicione produtos a sua lista de favoritos</p>
                </div>                  
      ...
      <div class="overlay-excluir">
        <div class="popup-delete">
          ...
          <div class="container-btns">
            ...
            <a href="#" class="btn_continue">Remover</a>
          </div>
        </div>
      </div>
