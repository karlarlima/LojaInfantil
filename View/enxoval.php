...
<body>
    <nav>
        ...
        <div class="navbar">
            <ul>
              ...
              <li><a href="enxoval.php" class="link active">Enxoval</a></li>
    ...
    <section class="container-body">
      <div class="filter-container">
        <span>Início <h5>/ Enxoval</h5></span>
        <form action="#">
          ...
          <div class="categorias-container">
            ...
            <div class="categorias">
              <input type="checkbox" id="banheiras" name="banheiras">
              <label for="banheiras">Banheiras</label>
            </div>
            <div class="categorias">
              <input type="checkbox" id="escovaCabelo" name="escovaCabelo">
              <label for="escovaCabelo">Escova para cabelo</label>
            </div>
            <div class="categorias">
                <input type="checkbox" id="mamae" name="mamae">
                <label for="mamae">Mamãe</label>
            </div>
            <div class="categorias">
              <input type="checkbox" id="quarto" name="quarto">
              <label for="quarto">Quarto de Bebê</label>
            </div>
            <div class="categorias">
            ...
            <div class="categorias">
              <input type="checkbox" id="trocador" name="trocador">
              <label for="trocador">Trocador</label>
            </div>
          </div>
...
$sql = "select * from produto where prod_cat = 3";
...
<div class='card'>
<li>
<a href='produto.php?produto_id=".$row['prod_id']."'><img src='../IMG/Enxoval/" . $row['prod_img1'] . "' alt=''></a>
<div class='card-content'>
  ...
  <div class='container-btns'>
      <a href='enxoval.php?add_favorito&produto_id=" . $row['prod_id'] . "' class='btn-add' name='add_favorito'>Favoritar<i class='ri-shopping-bag-2-fill'></i></a>
  </div>
</div>
</a>  
</li>
